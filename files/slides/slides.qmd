...
::: {.incremental}
- **10,730 police-recorded attacks** (2021--2025), linked to politicians, surveys, and posts
- **Mapping:** low-level, thinly spread, campaign-driven, ideological
- **Surveys:** at most a **weak link** between survey and police data
- **Communication:** uneven politicization — **more engagement**
:::
...
- Geocoded to **federal** (BTW 2021) and **state constituencies** (12 covered states)
:::
...
## Linking candidate surveys to police records {.smaller}
...
## Perceived security and recorded attacks {.smaller}
